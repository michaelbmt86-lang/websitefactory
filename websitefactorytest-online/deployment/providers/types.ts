...
export interface GitHubPushFolderConfig {
  repoFullName: string;
  branch: string;
  message: string;
  sourceDir: string;
...
export interface GitHubProvider {
  ...
  pushFolderCode(config: GitHubPushFolderConfig): Promise<ProviderResult<void>>;
  ...
  folderExists(repoFullName: string, branch: string, folderPath: string): Promise<ProviderResult<boolean>>;
}
...
export interface VercelProvider {
  ...
  connectGithub(projectId: string, repoFullName: string, productionBranch: string, rootDirectory?: string): Promise<ProviderResult<void>>;
