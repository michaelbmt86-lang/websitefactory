// ============================================================================
// WEBSITE BUILDER — OUTPUT GENERATOR (Stage 5a)
//
// Pipeline Contract:
//   INPUT:  SQLite tables (site_urls, product_urls, extracted_products, etc.)
//           written by upstream stages (Discovery, Product Discovery,
//           Detail Extraction, CMS Generator).
//   OUTPUT: Deployment-ready artifacts in docs/discovery/:
//     - site-map.json        (SiteMapOutput)      — site structure
//     - url-graph.json       (UrlGraphOutput)     — URL graph
//     - crawl-summary.json   (CrawlSummaryOutput) — crawl statistics
//     - delivery-report.json (DeliveryReportOutput) — full pipeline report
//
// This stage consumes NO external resources (no fetch, no APIs).
// It is a pure SQLite→filesystem transform.
// ============================================================================
